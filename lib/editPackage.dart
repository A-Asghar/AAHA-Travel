...
class _editPackage extends State<editPackage> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Center(
          child: Column(
            children: [
              userInput('Package Name', TextInputType.text,_nameController,widget.p.PName),
              userInput('Description', TextInputType.text,_descController,widget.p.Desc),
              userInput('Days', TextInputType.text,_daysController,widget.p.Days),
              userInput('Price', TextInputType.number,_priceController,widget.p.Price),
              userInput('Location', TextInputType.text,_locationController,widget.p.Location),
              ...
              Container(
                ...
                child: RaisedButton(
                  ...
                  onPressed: () async{
                    ...
                    await packageManagement.UpdatePackage(widget.p,FirebaseAuth.instance.currentUser, _nameController.text, _descController.text, _daysController.text, _priceController.text,_locationController.text, 0, context,ImgUrls1);
                    setState(() {

                    });
                    context.read<packageProvider>().updatePackage(widget.p, _nameController.text, _descController.text,_daysController.text ,_priceController.text,_locationController.text,ImgUrls1);
 ...
 userInput(String hintTitle, TextInputType keyboardType, TextEditingController a,String initalText) {
  return Container(
